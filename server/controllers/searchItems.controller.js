...
// FUNCTION to obtain items based on worker and description (DOBLE BUSQUEDA)
export const searchItemsByWorkerAndDescription = async (req, res, next) => {
    try {
        // valores de trabajador y descripcion de la consulta
...
/* NOT USED */
//FUNCTION TO GET DATA FROM A SINGLE ITEM BY THEIR WORKER and "CODIGO_PATRIMONIAL" (:id)
